...
function init(){
    window.addEventListener('touchmove', function onTouchMove(e) { e.preventDefault(); });
    ...
    document.getElementById('threeSixty').innerHTML = '<div id="pano"style="width:100%;height:100%;"></div>';
    embedpano( config );
    ...
    _settings = ADTECH.getContent('360 Pano: Popups', '[{"image":"mailPopup.png", "video":"demoVideo.mp4", "poster":"posterMail.jpg", "url":"https://www.oath.com/brands/yahoo-mail/"},{"image":"huffpostPopup.png", "video":"demoVideo.mp4", "poster":"posterHuffpost.jpg", "url":"https://www.oath.com/brands/huffpost/"},{"image":"sportsPopup.png", "video":"demoVideo.mp4", "poster":"posterSports.jpg", "url":"https://www.oath.com/brands/yahoo-sports/"},{"image":"financePopup.png", "video":"demoVideo.mp4", "poster":"posterFinance.jpg", "url":"https://www.oath.com/brands/yahoo-finance/"}]');
...
function setupPopup(item, index){
    ...
    item.getElementsByClassName('close')[0].addEventListener('click', function(){hidePopup(item, index)});
    item.getElementsByClassName('popupClick')[0].addEventListener('click', function(){handlePopupClickthrough(item, index)});
...
function krpanoReady(krpano) {
    ...
    var xml = '<krpano basedir="' + baseURL + '/">' +
        '<plugin ' +
            'name="gyro" ' +
            'devices="html5" ' +
            'keep="true" ' +
